package com.lxisoft.list;
import com.lxisoft.collection.*;
import java.util.*;
public class LinkedListDemo implements CollectionRepository
{
		...
		public void sort()
			{
		       ...
		       System.out.println("---------------------------");
				...
				System.out.println("Elements in sorted order : "+programmingLanguages);
		  }
		  ...
		  public void update()
			{
				...
				ele=scan.next();
				programmingLanguages.set(index,ele);
				System.out.println(" ");
