...
public class HashsetStore<T>implements CollectionRepository {
	Set<T> store=new HashSet<T>(); 
Class <T>type;
public HashsetStore(Class<T>type) {
	this.type=type;
}
private static final Logger log=Logger.getLogger(HashsetStore.class.getName());
public HashsetStore(){
