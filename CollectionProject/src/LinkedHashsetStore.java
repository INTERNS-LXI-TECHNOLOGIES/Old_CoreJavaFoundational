...
public class LinkedHashsetStore<T>implements CollectionRepository {
	Set<T> store=new LinkedHashSet<T>(); 
Class <T>type;
public LinkedHashsetStore(Class<T>type) {
	this.type=type;
}
private static final Logger log=Logger.getLogger(LinkedHashsetStore.class.getName());
public LinkedHashsetStore(){
