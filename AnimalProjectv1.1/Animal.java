 ...
 * Class Animal
 *
 * 	->    Animal(int pid)	[ Creates a Animal with id = pid ]
 *
 *   ->   void setCoordinates(int px , int py)	[ Set Animal Coordinates ]
 *
 *   ->   void setStrength(int pstrength)	 [ Set Animal strength ]
 *
 *   ->   void setHungerLevel(int phunger_level)	[ Set Animal hunger_level ]
 *
 *   ->   void printDetails(void)	[ Print animal Details ]
 *
 */
