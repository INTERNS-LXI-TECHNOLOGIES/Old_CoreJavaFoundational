...
public class QuestionPaperView
{
	...
	*/
	...
	public void updateFileView()
	{
		quizFileModel.setFileName("quizfile.csv");
		quizFileContol.createFile(quizFileModel.getFileName());
		System.out.println(quizFileModel.getFileName());
		...
		quizFileContol.updateFileContent(quizFileModel.getFileName(),oldString,newString);
	...
	public void deleteFileView()
	{
		...
		System.out.println("Enter the quetion id to be deleted from file: ");
		Scanner sc=new Scanner(System.in);
		String questionId=sc.nextLine();
		quizFileContol.deleteFileContent(questionId);
		// System.out.println("hellooooooo..."+line);
	}
