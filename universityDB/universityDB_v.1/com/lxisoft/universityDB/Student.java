...
public class Student{
	...
	public static String userName,regName,collegename;
	
	public static void studentPortal(String user,String regName)throws Exception
	{
		userName=user;
		FileReader reader=new FileReader("Database\\"+userName+regName+".properties");
		po.load(reader);
		Scanner dt=new Scanner(System.in);
		Scanner di=new Scanner(System.in);do{
		System.out.println("\n\n\t\t***********************************************************************************\n");	
