 ...
 *
 *  -  List<Animal> getAnimals() -> Returns all animals
 * 
...
public class Forest
{
    ...
    private List<Animal> fr_animals;
    ...
    public void setMaxNoAnimals(int no)
    {
        try
        {
            ...
            this.fr_animals = new CopyOnWriteArrayList<Animal>();
        ...
        try
        {
            ...
            if(this.getAnimal(animal.getId()) != null)
            {
                ...
                */
                ...
                for(Animal panimal : this.fr_animals)
                {
                    if(panimal.getId() == animal.getId())
                    {
                        kill = panimal;
                        this.fr_animals.remove(panimal);
                    }
                }
