...
///fight function///	
	...
	public void fight(Animal ani,int hunt_id)
		{
			...
			for(int i=0;i<7;i++)
			{
				...
				{	
					...
					if(name.equals(ani.getName().equals(hu.getStringName()))
					{System.out.println("Hunter chavunillal");}
					grid[i][j]=null;
