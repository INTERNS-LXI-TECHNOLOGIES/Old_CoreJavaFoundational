...
import com.lxisoft.animalgame.exception.BiggerThanGridException;
...
public class Forest 
{
	...
	public Forest(int i,int j,int k,int l) throws BiggerThanGridException
	{	
		if((i+j+k+l)>100)
			throw new BiggerThanGridException();
		for(m=0; m<l; m++)
		{
